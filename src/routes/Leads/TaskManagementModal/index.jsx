            ...
            <div className="p-4 bg-white/[0.03] border border-white/[0.06] rounded-xl">
              <div className="flex gap-3">
                <div className="flex-shrink-0">
                  <Bell className="w-4 h-4 text-[#dea402]" />
                </div>
                <div>
                  <p className="text-sm text-gray-400">
                    Task will be auto created and scheduled according to the lead Status and Protocol for <span className="font-semibold text-[#dea402]">{selectedLead.name}</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="sticky bottom-0 bg-[#262626] border-t border-white/[0.06] px-6 py-4">
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                disabled={formik.isSubmitting}
                className="flex-1 px-4 py-3 rounded-xl font-bold bg-gradient-to-r from-[#dea402] to-[#b38302] text-black transition-all duration-300 shadow-lg shadow-[#dea402]/10 hover:shadow-[#dea402]/25 transform hover:scale-[1.02] active:scale-[0.98] disabled:from-[#6b6354] disabled:to-[#5a5447] disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
              >

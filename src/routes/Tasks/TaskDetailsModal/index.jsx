...
if ((statusToCheck === 'Deposit' || statusToCheck === 'Not Deposit') && 
  ...
  return (
      ...
      >
        ...
        <div className="sticky top-0 bg-[#262626] border-b border-gray-600 px-6 py-4 flex items-center justify-between z-10">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-[#dea402]/10">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative flex">
                    <DatePicker
                      ...
                      className={`px-3 py-2 pl-10 rounded-lg bg-white/[0.04] text-white border focus:border-[#dea402] focus:outline-none focus:ring-2 focus:ring-[#dea402]/30 transition-all duration-300 text-sm hover:border-[#dea402]/50 ${isReminderDateEnabled() ? 'cursor-pointer border-white/10' : 'cursor-not-allowed border-gray-700 opacity-40'
                        }`}
                      calendarClassName="custom-datepicker"
                      wrapperClassName="w-full"
                      timeCaption="Time"
                    />
                    <Clock className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none ${isReminderDateEnabled() ? 'text-[#dea402]' : 'text-gray-600'
                      }`} />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <label className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 border ${isTaskUnassigned
                    ...
                    <input
                      ...
                      className="w-4 h-4 text-[#dea402] focus:ring-[#dea402] focus:ring-2 cursor-pointer disabled:cursor-not-allowed"
                    />
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center gap-3 cursor-pointer group">
                        <input
                          ...
                          className="w-5 h-5 rounded border border-white/10 bg-white/[0.04] checked:bg-[#dea402] checked:border-[#dea402] focus:ring-2 focus:ring-[#dea402]/30 cursor-pointer transition-all"
                        />
        ...
        <div className="sticky bottom-0 bg-[#262626] border-t border-white/[0.06] px-6 py-4">
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`max-w-full btn-animated btn-gold flex justify-center mx-auto !w-full bg-gradient-to-r from-[#dea402] to-[#b38302] text-black font-bold py-3 rounded-xl disabled:from-[#6b6354] disabled:to-[#5a5447] disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none transition-all duration-300 shadow-lg shadow-[#dea402]/10 hover:shadow-[#dea402]/25 transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group ${isFormValid() && !isSubmitting
                ? 'cursor-pointer'
    ...
    0%, 100% {
      border-color: rgba(222, 164, 2, 0.15);
      box-shadow: 0 0 0 0 rgba(222, 164, 2, 0);
    }
    50% {
      border-color: rgba(222, 164, 2, 0.4);
      box-shadow: 0 0 12px 2px rgba(222, 164, 2, 0.1);
    }
  }
  ...
  .animate-pulse-border-subtle {
    animation: pulse-border-subtle 2.5s ease-in-out infinite;
        ...
        .react-datepicker__time-container {
          position: absolute;
          right: 100%;
          border: 1px solid rgba(222, 164, 2, 0.2);
          border-radius: 12px;
          border-left: 1px solid rgba(222, 164, 2, 0.15) !important;
        }

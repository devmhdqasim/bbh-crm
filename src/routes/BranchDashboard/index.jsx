...
const Dashboard = () => {
    ...
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="border border-[#dea402]/30 rounded-lg p-6 bg-gradient-to-br from-[#4a1015] to-[#1a0405]"
          >
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-[#4a1015] border-2 border-[#dea402] rounded-lg p-4 shadow-2xl backdrop-blur-sm">
    ...
    <>
      <div className="min-h-screen bg-black text-white p-6">
        <main>
          ...
          <div className="relative flex flex-col md:flex-row md:items-center justify-between mb-8 bg-gradient-to-r from-[#dea402]/10 to-transparent border border-[#dea402]/30 rounded-2xl p-6 backdrop-blur-sm z-10">
            <div className="flex-1">
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full md:w-64 px-4 py-2.5 bg-gradient-to-br from-[#4a1015] to-[#1a0405] border border-[#dea402]/40 rounded-lg text-white text-sm font-medium appearance-none cursor-pointer hover:border-[#dea402] focus:border-[#dea402] focus:outline-none focus:ring-2 focus:ring-[#dea402]/20 transition-all pl-10 duration-300 shadow-lg"
                      style={{
          ...
          {!loading && dashboardData && (
            <div className="animate-fade-in">
                  ...
                  {selectedKioskMember === 'all' ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {kioskMemberOptions.map((member, index) => (
                        <div
                          key={member.kioskMemberId}
                          className="group relative w-full border border-[#dea402]/40 rounded-lg p-4 shadow-lg hover:shadow-2xl transition-all duration-500 hover:border-[#dea402] hover:scale-105 bg-gradient-to-br from-[#4a1015] to-[#1a0405] overflow-hidden"
                        ...
                        >
                          ...
                          <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-[#dea402]/20 to-transparent rounded-bl-full transform translate-x-8 -translate-y-8 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500"></div>
                          ...
                          <div className="relative">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <p className="text-lg font-bold text-white group-hover:text-[#dea402] transition-colors duration-300">
                                  {member.leadCount || 0}
                                </p>
                              </div>
                    ...
                    (() => {
                      ...
                      return member ? (
                        <div className="max-w-full mx-auto">
                          <div
                            className="group relative w-full border border-[#dea402]/40 rounded-lg p-4 shadow-lg hover:shadow-2xl transition-all duration-500 hover:border-[#dea402] hover:scale-101 bg-gradient-to-br from-[#4a1015] to-[#1a0405] overflow-hidden"
              ...
              >
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="group relative w-full border border-[#dea402]/40 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:border-[#dea402] hover:scale-101 bg-gradient-to-br from-[#4a1015] to-[#1a0405] overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      {/* Animated Corner Accent */}
                      <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#dea402]/20 to-transparent rounded-bl-full transform translate-x-10 -translate-y-10 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform pl-10 duration-500"></div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div
                  className="border border-[#dea402]/40 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-[#4a1015] to-[#1a0405] hover:border-[#dea402]"
                ...
                >
                  ...
                  {pieData.length > 0 ? (
                    <div className="space-y-4">
                      ...
                      <div className="bg-[#1a0405] rounded-lg p-4 border border-[#dea402]/30">
                        <div className="flex items-center justify-between">
          ...
          {!loading && !dashboardData && (
            <div className="text-center py-20 animate-fade-in">
              <div className="inline-block p-8 bg-gradient-to-br from-[#4a1015] to-[#1a0405] rounded-2xl border border-[#dea402]/30 shadow-2xl">

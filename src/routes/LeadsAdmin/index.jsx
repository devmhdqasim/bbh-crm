                  ...
                  <button
                    ...
                    className={`px-5 py-2 font-medium rounded-lg transition-all duration-300 flex items-center gap-2 ${
                      interestedSubTab === subTab
                        ...
                        : 'bg-[#5c1a20] text-gray-400 hover:text-white hover:bg-[#3A3A3A] border border-[#dea402]/30'
                    }`}
                  >
                    {subTab}
          ...
          <div className="overflow-x-auto">
            <table className="w-full ">
              <thead className="bg-[#4a1015] border-b border-[#dea402]/30">
                <tr>
                  <th className="text-left px-6 py-4 text-[#f5cc3a] font-semibold text-sm uppercase tracking-wider">Lead ID</th>
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <form onSubmit={formik.handleSubmit} className="flex-1 flex flex-col overflow-y-auto p-6">
            ...
            {/* Submit Buttons */}
            <div className="flex gap-3 sticky bottom-0 bg-[#4a1015] pt-4 border-t border-[#dea402]/30 mt-auto">
              <button
                type="button"
                onClick={handleCloseDrawer}

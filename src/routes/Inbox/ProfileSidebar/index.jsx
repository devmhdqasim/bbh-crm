...
const ProfileSidebar = ({
  ...
  return (
    <div className="w-80 bg-[#4a1015] border-l border-[#dea402]/30 flex flex-col animate-slideInRight overflow-hidden">
      {/* Profile Header */}
      <div className="p-5 border-b border-[#dea402]/20 flex-shrink-0">
        <div className="text-center">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#dea402] to-[#b38302] flex items-center justify-center mx-auto mb-4 shadow-xl">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-4">
        {/* Contact Info */}
        <div className="bg-[#5c1a20] rounded-xl p-4 border border-[#dea402]/10">
          <h4 className="text-gray-400 text-xs font-semibold uppercase tracking-wider mb-3">Contact Info</h4>
          <div className="space-y-3">
            {contact.email && (
              <div className="flex items-center gap-3 text-sm">
                <div className="w-8 h-8 rounded-full bg-[#dea402]/10 flex items-center justify-center flex-shrink-0">
                  <Mail className="w-4 h-4 text-[#dea402]" />
                </div>
            ...
            {contact.nationality && (
              <div className="flex items-center gap-3 text-sm">
                <div className="w-8 h-8 rounded-full bg-[#dea402]/10 flex items-center justify-center flex-shrink-0">
                  <Globe className="w-4 h-4 text-[#dea402]" />
                </div>
                <div className="flex-1 min-w-0">
            ...
            {contact.agent && contact.agent !== 'Not Assigned' && (
              <div className="flex items-center gap-3 text-sm">
                <div className="w-8 h-8 rounded-full bg-[#dea402]/10 flex items-center justify-center flex-shrink-0">
                  <User className="w-4 h-4 text-[#dea402]" />
                </div>
                <div className="flex-1 min-w-0">
        ...
        <div className="bg-[#5c1a20] rounded-xl p-4 border border-[#dea402]/10">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="text-[#dea402] hover:text-[#f0ba0a] text-xs font-medium transition-colors"
            >
          ...
          {showTagInput && (
            <div className="mb-3 flex gap-2">
              <input
                ...
                autoFocus
                className="flex-1 px-3 py-1.5 text-sm bg-[#4a1015] border border-[#dea402]/30 rounded-lg text-white focus:outline-none focus:border-[#dea402]"
              />
              <button
                onClick={handleAddTag}
                disabled={!newTag.trim()}
                className="px-3 py-1.5 bg-[#dea402] text-black rounded-lg text-sm font-medium hover:bg-[#f0ba0a] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Add
              </button>
            </div>
          ...
          {contactTags.length === 0 ? (
            ...
            <div className="flex flex-wrap gap-2">
              {contactTags.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#dea402]/10 text-[#dea402] rounded-full text-xs font-medium border border-[#dea402]/20 group hover:bg-[#dea402]/20 transition-all"
                >
        ...
        <div className="bg-[#5c1a20] rounded-xl p-4 border border-[#dea402]/10">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#dea402]/10 hover:bg-[#dea402]/20 text-[#dea402] rounded-lg text-sm font-semibold transition-all duration-300 hover:scale-105"
            >

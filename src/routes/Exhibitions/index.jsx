          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#4a1015] border-b border-[#dea402]/30">
                <tr>
                  <th className="text-left px-6 py-4 text-[#f5cc3a] font-semibold text-sm uppercase tracking-wider">Event ID</th>
                  <th className="text-left px-6 py-4 text-[#f5cc3a] font-semibold text-sm uppercase tracking-wider">Event Name</th>

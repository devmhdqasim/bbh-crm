  ...
  return (
    ...
    >
            ...
            <button
              ...
              className={`flex-1 px-6 py-3 font-semibold transition-all duration-300 ${
                activeModalTab === 'assign'
                  ? 'bg-white/[0.06] text-[#dea402] border-b-2 border-[#dea402]'
          ...
          <div className="p-6 space-y-6 min-h-[66vh]">
            ...
            {activeModalTab === 'assign' && (
              <div className="border-t border-white/[0.06] pt-6 space-y-4 animate-fadeIn">
                <h3 className="text-[10px] text-[#dea402]/60 font-semibold uppercase tracking-widest mb-4">Assign Lead to Agent</h3>
                
                {/* Assign to Self Checkbox */}
                <label className="flex items-center gap-3 p-4 rounded-lg bg-white/[0.03] hover:bg-white/[0.06] cursor-pointer transition-all duration-300 border border-[#dea402]/10 hover:border-[#dea402]/30">
                  <input
                    type="checkbox"
                    ...
                    className="w-5 h-5 text-[#dea402] focus:ring-[#dea402] focus:ring-2 rounded"
                  />
                  <div className="flex items-center gap-2">
                    <UserPlus className="w-5 h-5 text-[#dea402]" />
            ...
            {activeModalTab === 'status' && (
              ...
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] text-[#dea402]/60 font-semibold uppercase tracking-widest">Update Status</h3>
                ...
                <div className="flex items-center gap-2">
                  <div className="relative flex">
                    <DatePicker
                      ...
                      className={`px-3 py-2 pl-10 rounded-lg bg-white/[0.04] text-white border focus:border-[#dea402]/50 focus:outline-none focus:ring-2 focus:ring-[#dea402]/20 transition-all duration-300 text-sm ${
                ...
                <div className="grid grid-cols-2 gap-3">
                  <label className={`flex items-center gap-3 p-3 rounded-lg transition-all duration-300 border ${
                    answeredStatus === 'Answered'
                      ? 'bg-[#dea402]/10 border-[#dea402]/40 ring-1 ring-[#dea402]/30 cursor-pointer'
                      : 'bg-white/[0.03] hover:bg-white/[0.06] border-[#dea402]/10 hover:border-[#dea402]/30 cursor-pointer'
                  }`}>
                    <input
                      type="radio"
                      name="answeredStatus"
                ...
                <label className="text-[10px] text-[#dea402]/60 font-semibold uppercase tracking-widest block">
                          ...
                          isStatusDisabled('Not Interested')
                            ...
                            : isFinalSelectedStatus('Not Interested')
                              ...
                              : shouldShowNotInterestedAvailable()
                                ? 'bg-white/[0.04] hover:bg-white/[0.07] cursor-pointer border-[#dea402]/20 hover:border-[#dea402]/40 animate-pulse-border-subtle'
                                : 'bg-white/[0.03] hover:bg-white/[0.06] cursor-pointer border-[#dea402]/10 hover:border-[#dea402]/30'
                        }`}>
                          <input
                            type="radio"
                  ...
                  {modalHotLeadType === 'Demo' && (
                    <div className="mt-4 p-4 bg-white/[0.03] rounded-xl border border-white/[0.06] animate-fadeIn">
                      <h4 className="text-[#dea402] font-semibold mb-3 flex items-center gap-2">
                      ...
                      <div className="space-y-3">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer group">
                          <input
                            ...
                            className="w-5 h-5 rounded border border-white/10 bg-white/[0.04] checked:bg-[#dea402] checked:border-[#dea402] focus:ring-2 focus:ring-[#dea402]/20 cursor-pointer transition-all"
                          />
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 bg-white/[0.04] text-white resize-none transition-all duration-300 ${
                      modalErrors.remarks
                        ...
                        : 'border-white/[0.06] focus:border-[#dea402]/50 focus:ring-[#dea402]/20 hover:border-white/10'
                    }`}
                  />
                ...
                <div className={`${isUpdateStatusDisabled() ? 'opacity-40 pointer-events-none' : ''}`}>
                  ...
                  <div className="space-y-2 pt-4 border-t border-white/[0.06]">
                    ...
                    <input
                      ...
                      maxLength={100}
                      className="w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 bg-white/[0.04] text-white transition-all duration-300 border-white/[0.06] focus:border-[#dea402]/50 focus:ring-[#dea402]/20 hover:border-white/10"
                    />
                    <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            {activeModalTab === 'assign' && (
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl font-semibold bg-gradient-to-r from-[#dea402] to-[#b38302] text-black transition-all duration-300 shadow-lg shadow-[#dea402]/10 hover:shadow-[#dea402]/25 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
            ...
            {activeModalTab === 'status' && (
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-xl font-bold transition-all duration-300 shadow-lg transform ${
                  isStatusFormValid()
                    ? 'bg-gradient-to-r from-[#dea402] to-[#b38302] text-black shadow-lg shadow-[#dea402]/10 hover:shadow-[#dea402]/25 hover:scale-[1.02] active:scale-[0.98] cursor-pointer'
      ...
      <style>{`
        ...
        .custom-datepicker {
          background-color: #200607 !important;
          border: 2px solid rgba(222, 164, 2, 0.3) !important;
        ...
        .react-datepicker__header {
          background-color: #200607 !important;
          border-bottom: 1px solid rgba(222, 164, 2, 0.3) !important;
        ...
        .react-datepicker__time-container {
          position: absolute;
          right: 100%;
          border: 2px solid #f5cc3a3d;
          border-radius: 12px;
          border-left: 1px solid rgba(222, 164, 2, 0.3) !important;
        }

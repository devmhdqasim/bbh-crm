            ...
            toast.custom(
              (t) => (
                <div
                  ...
                  } max-w-md w-full bg-gradient-to-br from-[#5c1a20] to-[#4a1015] shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 border border-[#dea402]/30`}
                >
                  <div className="flex-1 w-0 p-4">
                    <div className="flex items-start">
                      <div className="flex-shrink-0 pt-0.5">
                        <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#dea402]/20 to-[#b38302]/20 flex items-center justify-center border border-[#dea402]/30">
                  ...
                  <div className="flex border-l border-[#dea402]/20">
                    <button
                      onClick={() => toast.dismiss(t.id)}
                      className="w-full border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-[#dea402] hover:text-[#b38302] focus:outline-none"
                    >
                      Close
                    </button>
                  </div>

...
const LoadingSpinner = ({ 
  ...
  const containerClasses = fullScreen
    ? 'fixed inset-0 flex items-center justify-center bg-[#dea402] z-50'
    ...
    <div className={containerClasses}>
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <div className="relative">
          {/* Outer ring */}
          <div
            className={`${sizeClasses[size]} border-4 border-[#b38302]/30 border-t-[#b38302] rounded-full animate-spin`}
          />
          ...
          <div
            ...
            } bg-[#b38302]/20 rounded-full animate-pulse`}
          />
        </div>
        ...
        {message && (
          <div className="flex flex-col items-center space-y-2">
            ...
            <div className="flex space-x-1">
              <div className="w-2 h-2 bg-[#b38302] rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
              <div className="w-2 h-2 bg-[#b38302] rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
              <div className="w-2 h-2 bg-[#b38302] rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
            </div>
          </div>
        )}
      </div>
...
export const InlineLoader = ({ message = '' }) => {
  return (
    <div className="flex items-center justify-center space-x-2">
      <div className="w-4 h-4 border-2 border-[#b38302]/30 border-t-[#b38302] rounded-full animate-spin" />

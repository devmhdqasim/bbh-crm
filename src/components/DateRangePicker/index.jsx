...
const DateRangePicker = ({
  ...
  return (
    <div className={`date-range-picker-container ${className}`}>
      <div className="flex items-center gap-3 bg-[#5c1a20] p-3 rounded-lg border border-[#dea402]/30 hover:border-[#dea402] transition-all duration-300">
        {/* Start Date */}
        <div className="flex items-center gap-2 flex-1">
          <label className="text-[#f5cc3a] text-sm font-medium whitespace-nowrap">
            {startLabel}
          </label>
          <div className="relative flex-1">
            ...
            />
            <Calendar className="absolute right-7 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#dea402] pointer-events-none" />
          </div>
        </div>

        {/* Separator */}
        <div className="w-px h-6 bg-[#dea402]/30"></div>
      ...
      <style jsx>{`
        ...
        .date-picker-input:focus {
          border-color: #dea402;
          box-shadow: 0 0 0 3px rgba(222, 164, 2, 0.1);
        }
        ...
        :global(.date-picker-calendar .react-datepicker__header) {
          ...
          border-bottom: 2px solid rgba(222, 164, 2, 0.3) !important;
        ...
        :global(.date-picker-calendar .react-datepicker__day--selected) {
          background: linear-gradient(135deg, #dea402 0%, #b38302 100%) !important;
          color: #000 !important;
          font-weight: 600 !important;
        }

        :global(.date-picker-calendar .react-datepicker__day--in-range) {
          background-color: rgba(222, 164, 2, 0.3) !important;
          color: white !important;
        }
        ...
        :global(.date-picker-calendar .react-datepicker__day--today) {
          border: 2px solid #dea402 !important;
          font-weight: 600 !important;
        }
        ...
        :global(.date-picker-calendar .react-datepicker__close-icon:hover::after) {
          background-color: #f5cc3a !important;
        }

      ...
      <div className={`w-full max-w-md relative z-10 transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="bg-[#37090b]/60 backdrop-blur-2xl border border-white/[0.06] rounded-3xl p-8 shadow-[0_25px_60px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between bg-[#252525]/80 rounded-lg p-3 border border-[#dea402]/10 hover:border-[#dea402]/30 transition-all duration-300 group">
              <div className="flex items-center gap-3 overflow-hidden">
                <div className="w-8 h-8 rounded-full bg-[#dea402]/10 flex items-center justify-center text-[#dea402]">
              ...
              <button
                ...
                disabled={isLoading}
                className="text-gray-400 hover:text-[#dea402] p-2 rounded-full hover:bg-[#dea402]/10 transition-all duration-300 disabled:opacity-50"
            ...
            <div className="relative">
              <div className="relative group">
                <input
                  ...
                  disabled={isLoading}
                  className={`w-full px-4 py-4 pr-12 bg-white/[0.04] text-white rounded-xl border transition-all duration-300 placeholder-gray-600 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed ${formik.touched.password && formik.errors.password
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 disabled:opacity-50 hover:text-[#dea402]`}
            ...
            <div className="text-center pt-2">
              <button
                ...
                className={`text-gray-400 hover:text-[#dea402] text-sm transition-all duration-300 hover:underline decoration-[#dea402]/50 underline-offset-4 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >

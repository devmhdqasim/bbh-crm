  ...
  return (
    <div className="min-h-screen bg-[#1a0405] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(222,164,2,0.08),transparent_60%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_120%,rgba(74,16,21,0.5),transparent_60%)]"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#37090b] rounded-full filter blur-[180px] opacity-60"></div>
      </div>
      ...
      <div className={`w-full max-w-md relative z-10 transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="bg-[#37090b]/60 backdrop-blur-2xl border border-white/[0.06] rounded-3xl p-8 shadow-[0_25px_60px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#dea402]/60 text-[10px] font-semibold uppercase tracking-[0.25em] mb-4">
              BBH CRM Portal
            </p>
            <p className="text-[#dea402]/80 text-sm font-medium uppercase tracking-widest">
          ...
          <div className="space-y-6">
            ...
            <div className="relative group">
              <input
                ...
                disabled={isLoading}
                className={`w-full px-4 py-4 bg-white/[0.04] text-white rounded-xl border transition-all duration-300 placeholder-gray-600 focus:outline-none focus:bg-white/[0.06] focus:shadow-[0_0_20px_rgba(222,164,2,0.08)] disabled:opacity-50 disabled:cursor-not-allowed ${formik.touched.login && formik.errors.login
            ...
            <button
              ...
              className="btn-animated btn-gold flex justify-center mx-auto !max-w-full !w-full bg-[#dea402] hover:bg-[#f0ba0a] text-[#1a0405] font-bold text-sm py-4 rounded-xl disabled:bg-white/10 disabled:text-white/30 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none transition-all duration-300 shadow-[0_0_30px_rgba(222,164,2,0.15)] hover:shadow-[0_0_40px_rgba(222,164,2,0.25)] active:scale-[0.98] relative overflow-hidden group"
              >
        ...
        <div className="flex items-center justify-center gap-3 mt-6 flex-wrap opacity-0 animate-fadeIn" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
          <div className="flex items-center gap-1.5 text-[#dea402]/50 text-[10px] uppercase tracking-wider">
            <Shield size={10} />
            <span>Encrypted</span>
          </div>
          <div className="w-px h-3 bg-[#dea402]/20"></div>
          <div className="flex items-center gap-1.5 text-[#dea402]/50 text-[10px] uppercase tracking-wider">
            <Zap size={10} />
            <span>Real-time</span>
          </div>
